...
module.exports = function (enums) {
    ...
    attributeTypeMap[homeeEnums.CAAttributeType.CAAttributeTypeCurrent] = {name: "Current", roleDetail: ".power.current"};
    attributeTypeMap[homeeEnums.CAAttributeType.CAAttributeTypeFrequency] = {name: "Frequency", roleDetail: ".power.frequency"};
    attributeTypeMap[homeeEnums.CAAttributeType.CAAttributeTypeVoltage] = {name: "Voltage", roleDetail: ".power.voltage"};
