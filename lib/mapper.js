...
module.exports = function (enums) {
    ...
    profileTypeMap[homeeEnums.CANodeProfile.CANodeProfileOnOffPlug] = {name: 'OnOffPlug', roleDetail: 'switch'};
    ...
    profileTypeMap[homeeEnums.CANodeProfile.CANodeProfileOnOffSwitch] = {name: 'OnOffSwitch', roleDetail: 'switch'};
    ...
    profileTypeMap[homeeEnums.CANodeProfile.CANodeProfileDoubleOnOffPlug] = {name: 'DoubleOnOffPlug', roleDetail: 'switch'};
	...
	// updated enums 2.22.2
	profileTypeMap[homeeEnums.CANodeProfile.CANodeProfileEnergyManager] = {name: 'EnergyManager', roleDetail: ''};
	profileTypeMap[homeeEnums.CANodeProfile.CANodeProfileLevelMeter] = {name: 'LevelMeter', roleDetail: ''};
	profileTypeMap[homeeEnums.CANodeProfile.CANodeProfileRangeExtender] = {name: 'RangeExtender', roleDetail: ''};
	profileTypeMap[homeeEnums.CANodeProfile.CANodeProfileVentilationControl] = {name: 'VentilationControl', roleDetail: ''};
	// updated enums 2.26.0
	profileTypeMap[homeeEnums.CANodeProfile.CANodeProfileThermostatWithHeatingAndCooling] = {name: 'ThermostatWithHeatingAndCooling', roleDetail: ''};
	profileTypeMap[homeeEnums.CANodeProfile.CANodeProfileHeatingSystem] = {name: 'HeatingSystem', roleDetail: ''};
	profileTypeMap[homeeEnums.CANodeProfile.CANodeProfileWarmWaterCircuit] = {name: 'WarmWaterCircuit', roleDetail: ''};
    // updated enums 2.27.0
    profileTypeMap[homeeEnums.CANodeProfile.CANodeProfileEntranceGateOperator] = {name: 'EntranceGateOperator', roleDetail: ''};
    profileTypeMap[homeeEnums.CANodeProfile.CANodeProfilePerimeterProtectionSystem] = {name: 'PerimeterProtectionSystem', roleDetail: ''};
    profileTypeMap[homeeEnums.CANodeProfile.CANodeProfileGarageDoorOperator] = {name: 'GarageDoorOperator', roleDetail: ''};
    profileTypeMap[homeeEnums.CANodeProfile.CANodeProfileGateOperator] = {name: 'ProfileGateOperator', roleDetail: ''};
    // updated enums 2.28.0 - NONE
    // updated enums 2.29.0
    profileTypeMap[homeeEnums.CANodeProfile.CANodeProfileRemote] = {name: 'Remote', roleDetail: ''};
    profileTypeMap[homeeEnums.CANodeProfile.CANodeProfileImpulsePlug] = {name: 'ImpulsePlug', roleDetail: ''};
    profileTypeMap[homeeEnums.CANodeProfile.CANodeProfileImpulseRelay] = {name: 'ImpulseRelay', roleDetail: ''};
    profileTypeMap[homeeEnums.CANodeProfile.CANodeProfileInnerDoorOperator] = {name: 'InnerDoorOperator', roleDetail: ''};
    profileTypeMap[homeeEnums.CANodeProfile.CANodeProfileGarageDoorImpulseOperator] = {name: 'GarageDoorImpulseOperator', roleDetail: ''};
    // updated enums 2.30.0
    profileTypeMap[homeeEnums.CANodeProfile.CANodeProfileEntranceDoor] = {name: 'EntranceDoor', roleDetail: ''};
    profileTypeMap[homeeEnums.CANodeProfile.CANodeProfileWindowMotorSwitch] = {name: 'WindowMotorSwitch', roleDetail: ''};
    // updated enums 2.31.0
    profileTypeMap[homeeEnums.CANodeProfile.CANodeProfileTracker] = {name: 'Tracker', roleDetail: ''};
    // updated enums 2.32.0 - NONE
    ...
    attributeTypeMap[homeeEnums.CAAttributeType.CAAttributeTypeOnOff] = {name: 'OnOff', roleDetail: 'switch'};
    ...
    attributeTypeMap[homeeEnums.CAAttributeType.CAAttributeTypePosition] = {name: 'Position', roleDetail: '.blind'};
    ...
    attributeTypeMap[homeeEnums.CAAttributeType.CAAttributeTypeLinkQuality] = {name: 'LinkQuality', roleDetail: 'sensor'};
    ...
    attributeTypeMap[homeeEnums.CAAttributeType.CAAttributeTypeHighTemperatureAlarm] = {name: 'HighTemperatureAlarm', roleDetail: '.alarm'};
    ...
    attributeTypeMap[homeeEnums.CAAttributeType.CAAttributeTypeLowTemperatureAlarm] = {name: 'LowTemperatureAlarm', roleDetail: '.alarm'};
    ...
    attributeTypeMap[homeeEnums.CAAttributeType.CAAttributeTypePresenceAlarm] = {name: 'PresenceAlarm', roleDetail: '.motion'};
    attributeTypeMap[homeeEnums.CAAttributeType.CAAttributeTypeMinimumAlarm] = {name: 'MinimumAlarm', roleDetail: '.alarm.min'};
    attributeTypeMap[homeeEnums.CAAttributeType.CAAttributeTypeMaximumAlarm] = {name: 'MaximumAlarm', roleDetail: '.alarm.max'};
    attributeTypeMap[homeeEnums.CAAttributeType.CAAttributeTypeOilAlarm] = {name: 'OilAlarm', roleDetail: '.alarm'};
    attributeTypeMap[homeeEnums.CAAttributeType.CAAttributeTypeWaterAlarm] = {name: 'WaterAlarm', roleDetail: '.alarm'};
    ...
    attributeTypeMap[homeeEnums.CAAttributeType.CAAttributeTypeShutterBlindMode] = {name: 'ShutterBlindMode', roleDetail: 'sensor'};
    ...
    attributeTypeMap[homeeEnums.CAAttributeType.CAAttributeTypeSurveillanceOnOff] = {name: 'SurveillanceOnOff', roleDetail: 'switch'};
    ...
    attributeTypeMap[homeeEnums.CAAttributeType.CAAttributeTypeCurrent] = {name: 'Current', roleDetail: '.current'};
    attributeTypeMap[homeeEnums.CAAttributeType.CAAttributeTypeFrequency] = {name: 'Frequency', roleDetail: ''};
    attributeTypeMap[homeeEnums.CAAttributeType.CAAttributeTypeVoltage] = {name: 'Voltage', roleDetail: '.voltage'};
	...
	// updated enums 2.22.2
	attributeTypeMap[homeeEnums.CAAttributeType.CAAttributeTypeLevel] = {name: 'Level', roleDetail: ''};
	attributeTypeMap[homeeEnums.CAAttributeType.CAAttributeTypeSerialNumber] = {name: 'SerialNumber', roleDetail: ''};
	attributeTypeMap[homeeEnums.CAAttributeType.CAAttributeTypeOutdoorRelativeHumidity] = {name: 'OutdoorRelativeHumidity', roleDetail: '.humidity'};
	attributeTypeMap[homeeEnums.CAAttributeType.CAAttributeTypeIndoorRelativeHumidity] = {name: 'IndoorRelativeHumidity', roleDetail: '.humidity'};
	attributeTypeMap[homeeEnums.CAAttributeType.CAAttributeTypeOutdoorTemperature] = {name: 'OutdoorTemperature', roleDetail: '.temperature'};
	attributeTypeMap[homeeEnums.CAAttributeType.CAAttributeTypeIndoorTemperature] = {name: 'IndoorTemperature', roleDetail: '.temperature'};
	attributeTypeMap[homeeEnums.CAAttributeType.CAAttributeTypeVentilationLevel] = {name: 'VentilationLevel', roleDetail: '.ventilation'};
	attributeTypeMap[homeeEnums.CAAttributeType.CAAttributeTypeVentilationMode] = {name: 'VentilationMode', roleDetail: ''};
	attributeTypeMap[homeeEnums.CAAttributeType.CAAttributeTypeIntakeMotorRevs] = {name: 'IntakeMotorRevs', roleDetail: ''};
	attributeTypeMap[homeeEnums.CAAttributeType.CAAttributeTypeExhaustMotorRevs] = {name: 'ExhaustMotorRevs', roleDetail: ''};
	attributeTypeMap[homeeEnums.CAAttributeType.CAAttributeTypeOperatingHours] = {name: 'OperatingHours', roleDetail: ''};
	attributeTypeMap[homeeEnums.CAAttributeType.CAAttributeTypePowerOutputGrid] = {name: 'PowerOutputGrid', roleDetail: '.power'};
	attributeTypeMap[homeeEnums.CAAttributeType.CAAttributeTypePowerInputGrid] = {name: 'PowerInputGrid', roleDetail: '.power'};
	attributeTypeMap[homeeEnums.CAAttributeType.CAAttributeTypePowerPV] = {name: 'PowerPV', roleDetail: '.power'};
	attributeTypeMap[homeeEnums.CAAttributeType.CAAttributeTypePowerLoad] = {name: 'PowerLoad', roleDetail: '.power'};
	attributeTypeMap[homeeEnums.CAAttributeType.CAAttributeTypePowerOutputBattery] = {name: 'PowerOutputBattery', roleDetail: '.power'};
	attributeTypeMap[homeeEnums.CAAttributeType.CAAttributeTypePowerInputBattery] = {name: 'PowerInputBattery', roleDetail: '.power'};
	attributeTypeMap[homeeEnums.CAAttributeType.CAAttributeTypeRelativeAutonomy] = {name: 'RelativeAutonomy', roleDetail: '.power'};
	attributeTypeMap[homeeEnums.CAAttributeType.CAAttributeTypeTotalCurrent] = {name: 'TotalCurrent', roleDetail: '.power'};
	attributeTypeMap[homeeEnums.CAAttributeType.CAAttributeTypeEnergyStorageLevel] = {name: 'EnergyStorageLevel', roleDetail: '.power'};
	attributeTypeMap[homeeEnums.CAAttributeType.CAAttributeTypeTotalEnergyLoad] = {name: 'TotalEnergyLoad', roleDetail: '.power'};
	attributeTypeMap[homeeEnums.CAAttributeType.CAAttributeTypeTotalEnergyProduction] = {name: 'TotalEnergyProduction', roleDetail: '.power'};
	attributeTypeMap[homeeEnums.CAAttributeType.CAAttributeTypeTotalEnergyOutputGrid] = {name: 'TotalEnergyOutputGrid', roleDetail: '.power'};
	attributeTypeMap[homeeEnums.CAAttributeType.CAAttributeTypeTotalEnergyInputGrid] = {name: 'TotalEnergyInputGrid', roleDetail: '.power'};
	attributeTypeMap[homeeEnums.CAAttributeType.CAAttributeTypeTotalEnergyStored] = {name: 'TotalEnergyStored', roleDetail: '.power'};
	attributeTypeMap[homeeEnums.CAAttributeType.CAAttributeTypeTotalEnergyRestored] = {name: 'TotalEnergyRestored', roleDetail: '.power'};
	attributeTypeMap[homeeEnums.CAAttributeType.CAAttributeTypeReplaceFilterAlarm] = {name: 'ReplaceFilterAlarm', roleDetail: '.alarm'};
	// updated enums 2.26.0
    attributeTypeMap[homeeEnums.CAAttributeType.CAAttributeTypeWarmWaterTemperature] = {name: 'WarmWaterTemperature', roleDetail: '.temperature'};
	attributeTypeMap[homeeEnums.CAAttributeType.CAAttributeTypeWarmWaterTargetTemperature] = {name: 'WarmWaterTargetTemperature', roleDetail: '.temperature'};
	attributeTypeMap[homeeEnums.CAAttributeType.CAAttributeTypeTargetTemperatureOffset] = {name: 'TargetTemperatureOffset', roleDetail: '.temperature'};
	attributeTypeMap[homeeEnums.CAAttributeType.CAAttributeTypeSavingFactor] = {name: 'SavingFactor', roleDetail: '.power'};
	attributeTypeMap[homeeEnums.CAAttributeType.CAAttributeTypeTotalVoltage] = {name: 'TotalVoltage', roleDetail: '.power'};
	attributeTypeMap[homeeEnums.CAAttributeType.CAAttributeTypeHeatingProgram] = {name: 'HeatingProgram', roleDetail: ''};
	attributeTypeMap[homeeEnums.CAAttributeType.CAAttributeTypeWarmWaterProgram] = {name: 'WarmWaterProgram', roleDetail: ''};
	attributeTypeMap[homeeEnums.CAAttributeType.CAAttributeTypeExternalBinaryInput] = {name: 'ExternalBinaryInput', roleDetail: ''};
	attributeTypeMap[homeeEnums.CAAttributeType.CAAttributeTypeButtonPressedLong] = {name: 'ButtonPressedLong', roleDetail: ''};
    // updated enums 2.27.0
    attributeTypeMap[homeeEnums.CAAttributeType.CAAttributeTypeMemoryUsage] = {name: 'MemoryUsage', roleDetail: ''};
    attributeTypeMap[homeeEnums.CAAttributeType.CAAttributeTypeProcessorUtilization] = {name: 'ProcessorUtilization', roleDetail: ''};
    attributeTypeMap[homeeEnums.CAAttributeType.CAAttributeTypeUsedStorage] = {name: 'UsedStorage', roleDetail: ''};
    attributeTypeMap[homeeEnums.CAAttributeType.CAAttributeTypeExternalTemperature] = {name: 'ExternalTemperature', roleDetail: '.temperature'};
    attributeTypeMap[homeeEnums.CAAttributeType.CAAttributeTypeFloorTemperature] = {name: 'FloorTemperature', roleDetail: '.temperature'};
    // updated enums 2.28.0 - NONE
    // updated enums 2.29.0
    attributeTypeMap[homeeEnums.CAAttributeType.CAAttributeTypeUpDownRemote] = {name: 'UpDownRemote', roleDetail: ''};
    attributeTypeMap[homeeEnums.CAAttributeType.CAAttributeTypeDawn] = {name: 'Dawn', roleDetail: ''};
    attributeTypeMap[homeeEnums.CAAttributeType.CAAttributeTypeImpulse] = {name: 'Impulse', roleDetail: ''};
    attributeTypeMap[homeeEnums.CAAttributeType.CAAttributeTypeSlatMinAngle] = {name: 'SlatMinAngle', roleDetail: ''};
    attributeTypeMap[homeeEnums.CAAttributeType.CAAttributeTypeSlatMaxAngle] = {name: 'SlatMaxAngle', roleDetail: ''};
    attributeTypeMap[homeeEnums.CAAttributeType.CAAttributeTypeMotorRotation] = {name: 'MotorRotation', roleDetail: ''};
    // updated enums 2.29.0
    attributeTypeMap[homeeEnums.CAAttributeType.CAAttributeTypeRainfallIntensity] = {name: 'RainfallIntensity', roleDetail: ''};
    attributeTypeMap[homeeEnums.CAAttributeType.CAAttributeTypeCurrentElectricityPrice] = {name: 'CurrentElectricityPrice', roleDetail: ''};
    attributeTypeMap[homeeEnums.CAAttributeType.CAAttributeTypeHighestElectricityPrice] = {name: 'HighestElectricityPrice', roleDetail: ''};
    attributeTypeMap[homeeEnums.CAAttributeType.CAAttributeTypeLowestElectricityPrice] = {name: 'LowestElectricityPrice', roleDetail: ''};
    attributeTypeMap[homeeEnums.CAAttributeType.CAAttributeTypeCurrentEnergyConsumption] = {name: 'CurrentEnergyConsumption', roleDetail: ''};
    attributeTypeMap[homeeEnums.CAAttributeType.CAAttributeTypeCurrentCosts] = {name: 'CurrentCosts', roleDetail: ''};
    attributeTypeMap[homeeEnums.CAAttributeType.CAAttributeTypeEndPositionConfiguration] = {name: 'EndPositionConfiguration', roleDetail: ''};
    attributeTypeMap[homeeEnums.CAAttributeType.CAAttributeTypeAutomaticModeImpulse] = {name: 'AutomaticModeImpulse', roleDetail: ''};
    attributeTypeMap[homeeEnums.CAAttributeType.CAAttributeTypeBrieflyOpenImpulse] = {name: 'BrieflyOpenImpulse', roleDetail: ''};
    attributeTypeMap[homeeEnums.CAAttributeType.CAAttributeTypePermanentlyOpenImpulse] = {name: 'PermanentlyOpenImpulse', roleDetail: ''};
    attributeTypeMap[homeeEnums.CAAttributeType.CAAttributeTypeWindThreshold] = {name: 'WindThreshold', roleDetail: ''};
    attributeTypeMap[homeeEnums.CAAttributeType.CAAttributeTypeSlatRotationImpulse] = {name: 'SlatRotationImpulse', roleDetail: ''};
    // updated enums 2.31.0 - NONE
    // updated enums 2.32.0
    attributeTypeMap[homeeEnums.CAAttributeType.CAAttributeTypeHVACOperatingState] = {name: 'HVACOperatingState', roleDetail: ''};
    attributeTypeMap[homeeEnums.CAAttributeType.CAAttributeTypeExternalTemperatureOffset] = {name: 'ExternalTemperatureOffset', roleDetail: ''};
    attributeTypeMap[homeeEnums.CAAttributeType.CAAttributeTypeFloorTemperatureOffset] = {name: 'FloorTemperatureOffset', roleDetail: ''};
    attributeTypeMap[homeeEnums.CAAttributeType.CAAttributeTypeDisplayBrightnessActive] = {name: 'DisplayBrightnessActive', roleDetail: ''};
    attributeTypeMap[homeeEnums.CAAttributeType.CAAttributeTypeDisplayBrightnessDimmed] = {name: 'DisplayBrightnessDimmed', roleDetail: ''};
    attributeTypeMap[homeeEnums.CAAttributeType.CAAttributeTypeButtonBrightnessActive] = {name: 'ButtonBrightnessActive', roleDetail: ''};
    attributeTypeMap[homeeEnums.CAAttributeType.CAAttributeTypeButtonBrightnessDimmed] = {name: 'ButtonBrightnessDimmed', roleDetail: ''};
    attributeTypeMap[homeeEnums.CAAttributeType.CAAttributeTypeDisplayTemperatureSelection] = {name: 'DisplayTemperatureSelection', roleDetail: ''};
    // updated enums 2.32.0
    attributeTypeMap[homeeEnums.CAAttributeType.CAAttributeTypeMotorBlockedAlarm] = {name: 'MotorBlockedAlarm', roleDetail: ''};
    attributeTypeMap[homeeEnums.CAAttributeType.CAAttributeTypeFreezeProtection] = {name: 'FreezeProtection', roleDetail: ''};
    attributeTypeMap[homeeEnums.CAAttributeType.CAAttributeTypeFlyScreen] = {name: 'FlyScreen', roleDetail: ''};
    attributeTypeMap[homeeEnums.CAAttributeType.CAAttributeTypeSunProtection] = {name: 'SunProtection', roleDetail: ''};
    attributeTypeMap[homeeEnums.CAAttributeType.CAAttributeTypeMemo] = {name: 'Memo', roleDetail: ''};
    attributeTypeMap[homeeEnums.CAAttributeType.CAAttributeWindMonitoringState] = {name: 'WindMonitoringState', roleDetail: ''};
    attributeTypeMap[homeeEnums.CAAttributeType.CAAttributeTypeAutomaticRuntimeCalculation] = {name: 'AutomaticRuntimeCalculation', roleDetail: ''};
    attributeTypeMap[homeeEnums.CAAttributeType.CAAttributeTypeDownPosition] = {name: 'DownPosition', roleDetail: ''};
    attributeTypeMap[homeeEnums.CAAttributeType.CAAttributeTypeDownSlatPosition] = {name: 'DownSlatPosition', roleDetail: ''};
    attributeTypeMap[homeeEnums.CAAttributeType.CAAttributeTypeCOValue] = {name: 'COValue', roleDetail: ''};

    module.mapAttributeProperties = function (node_name, attribute) {
        const common = {};

        node_name = decodeURIComponent(node_name);
